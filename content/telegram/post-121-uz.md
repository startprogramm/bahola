# Post 121 — Telegram (Uzbek)
**Campaign:** Week 40 — Platform Integrations: eMaktab Connection Deep Dive
**Language:** Uzbek
**Theme:** eMaktab integratsiyasi — tez-tez so'raladigan savollar
...
**1. «eMaktabga eksport» tugmasi qayerda?**
→ Baholash tugagach, "Natijalar" sahifasining yuqori qismida paydo bo'ladi. Ko'rinmasa — maktab identifikatori bog'langanini tekshiring (Sozlamalar → Maktab profili).

**2. Baholar avtomatik yuboriladimi, yoki har safar bosish kerakmi?**
...
**5. Maktab identifikatorini qaerdan topaman?**
→ Maktab direktori yoki IT bo'limidan so'rang. U eMaktab admin panelida "Maktab kodi" deb ko'rsatilgan.
