...
**Format:** 45s split-screen comparison, Uzbek + Russian captions
...
| 13-20s | Writing down scores per student per question | Bar chart: "Fractions — 41% class average" glows red |
...
- Split-screen vertical format (each half 4.5:16)
- Left side: warm/warm-orange tones (stress, frustration)
- Right side: cool/teal tones (calm, efficient)
- Timer graphic in corner of each side showing elapsed time
