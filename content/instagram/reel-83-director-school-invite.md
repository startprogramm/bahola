...
language: uz+ru
date: 2027-03-17
format: authority-proof-confidence
duration: 45s
---
...
**[18–33s] — Panel to'ladi / Панель заполняется**
- Fast-cut timelapse: director's dashboard panel populating live
  - "Aliyeva N. qo'shildi ✅ — 14:32"
  - "Karimov S. qo'shildi ✅ — 14:35"
  - "Yusupova M. qo'shildi ✅ — 14:38"
  - "Rashidov T. qo'shildi ✅ — 14:41"
  - ... up to 12 green checkmarks
- Overlay (UZ): "O'qituvchilar o'zlari ro'yxatdan o'tishadi. Siz hech nima qilmaysiz."
- Overlay (RU): "Учителя регистрируются сами. Вам ничего не нужно делать."
- Final state: "12/12 o'qituvchi faol ✅"

**[33–40s] — Direktor paneli / Панель директора**
- Director scrolls through active teacher list — classes assigned, subjects visible
- Overlay (UZ): "Sinflar. Fanlar. Kim nima o'qitayotgani — barchasi ko'rinadi."
- Overlay (RU): "Классы. Предметы. Кто что преподаёт — всё видно."
- Director nods approvingly at the organized dashboard
...
```
🏫 12 ta o'qituvchi. 1 ta havola. Bajarildi.

Direktor sifatida siz 1 ta harakat qilasiz:
Maktab taklif havolasini nusxalab, umumiy chatga yuboring.

Qolganini o'qituvchilar o'zlari bajarishadi.
Siz esa — panelingizda hammasi ko'rinishini kuzatasiz.

Yangi o'quv yili uchun eng oson onboarding.

---

🏫 12 учителей. 1 ссылка. Готово.

Как директор — вы делаете одно действие:
Копируете ссылку школы и отправляете в общий чат.

Остальное — учителя делают сами.
А вы видите в панели: кто зарегистрировался, кто активен.
...
- Audio: quiet tension → satisfying notification pings → confident upbeat resolve
