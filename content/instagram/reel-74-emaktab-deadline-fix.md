...
reel: 74
week: 37
theme: Director Perspective — eMaktab Deadline Compliance
language: uz+ru
date: 2027-02-17
format: problem-solution-reveal
duration: 45s
---
...
Bold red overlay: **"21:00 — eMaktab muhlati!"** / **"21:00 — дедлайн eMaktab!"**
Heartbeat sound effect or urgent tick.

## Scene Breakdown

**[0–6s] — Muammo / Проблема**
- Clock on phone shows 20:41
- Teacher visible in background, stack of papers, stressed expression
- Overlay: "30 ta o'quvchi ishini qo'lda tekshirish — 3+ soat"
- Overlay (RU): "30 работ вручную — 3+ часа"
- Overlay: "Kech qolsangiz → eMaktabda jarima → maosh kamayadi"

**[6–14s] — Haqiqat / Реальность**
- Screen: eMaktab.uz interface showing grading deadline timer
- Overlay: "30% dan kam baho qo'yilsa — jarima"
- Overlay (RU): "Меньше 30% оценок до 21:00 → штраф"
...
**[36–41s] — Direktor uchun / Для директора**
...
📸 Rasm ol
🤖 AI tekshiradi
✅ 10 daqiqada butun sinf — baholangan

Jarima emas. Stress emas. Faqat natija.
...
## Production Notes
- Real clock countdown adds urgency — use phone clock or wall clock
- eMaktab interface: show real UI if possible (anonymized), or a clear mock-up
- Teacher should look genuinely stressed in "before" segment, genuinely relaxed in "after"
