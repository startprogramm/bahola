...
reel: 80
week: 40
theme: Platform Integrations — eMaktab Sync Step-by-Step
language: uz+ru
date: 2027-03-09
...
**[6–14s] — 1-qadam: Eksport / Шаг 1: Экспорт**
- Teacher taps "eMaktab'ga yuborish" button — highlighted with subtle glow
- Modal appears confirming class and date range
- Overlay (UZ): "1️⃣ «eMaktabga yuborish» — bosing"
- Overlay (RU): "1️⃣ Нажмите «Экспорт в eMaktab»"
- Finger taps confirm

**[14–22s] — 2-qadam: Avtomatik sinxronlash / Шаг 2: Синхронизация**
- Progress animation: "Baholar yuborilmoqda… 28/28"
- Overlay (UZ): "2️⃣ Sistema o'zi yuboradi — siz hech nima kiritmaysiz"
- Overlay (RU): "2️⃣ Система сама всё передаёт — без ввода вручную"
...
Soat 21:00 muhlati — endi muammo emas.

---

28 оценок. eMaktab. 30 секунд.
...
- Audio: clean UI sounds (tap, swipe, success chime) over a light upbeat background
- Pace: crisp and confident — no hesitation in the demo
