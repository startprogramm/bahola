# Reel 40: Q1 Data Story

**Slug:** `reel-40-q1-data-story`
**Publish date:** October 21, 2026 (Wednesday — mid-week Q1 close)
...
| # | Shot | Visual | Audio |
|---|------|--------|-------|
| 1 | Hook | Teacher's hand unlocks phone. Dashboard loads. Quarter summary appears. | Soft notification chime |
| 2 | Scroll — classes | Teacher scrolls: 3 classes listed, each with submission count and avg score bar | Ambient background music, quiet and focused |
| 3 | Zoom — class 1 | Class bar chart: scores week by week, trending up. Subtle green glow on the final bar | Music holds |
| 4 | Zoom — class 2 | Another chart. Different curve — slower start, strong finish. Teacher tilts head, nods. | Music holds |
...
> **"Birinchi chorak — raqamlar gapiradi."**
> *(First quarter — the numbers speak.)*
...
**Uzbek:**
```
Birinchi chorak tugadi. Raqamlar gapiradi. 📊
...
```
Q1 is done. Let the numbers talk. 📊
...
- **Pacing:** Slower than a typical reel. This is contemplative content, not a fast cut. 3–4 sec per shot.
- **Color:** Dashboard blue/white palette. Let the product speak. Avoid heavy filters.
