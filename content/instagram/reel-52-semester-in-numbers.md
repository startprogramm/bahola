# Reel 52: "Your Semester in Numbers"

**Slug:** `reel-52-semester-in-numbers`
**Publish date:** December 1, 2026 (Tuesday — End-of-Term Wrap week)
...
|---|-----------|------|--------|--------------|-------|
| 1 | 0:00–0:03 | Hook | Dark background. Bold white text. A subtle countdown-style animation starts. | "Bu semestr siz nima qildingiz?" | Upbeat but warm beat — like a year-end highlight reel |
| 2 | 0:03–0:09 | Stat 1 | Large animated counter rolls up to: 847. Stylized, satisfying number reveal. | "847 ta ish baholandi" | Counter sound effect, music continues |
...
```
Shot 1:  "Bu semestr siz nima qildingiz?"
Shot 2:  "847 ta ish baholandi"
Shot 3:  "3,388 daqiqa tejaldi — 56 soat"
Shot 4:  "2,500+ ta batafsil fikr-mulohaza"
Shot 5:  "Bu — siz. Bu semestrda."
Shot 6:  "Keyingi semestr yanada yaxshiroq bo'ladi. teztek.uz"
```
...
Celebratory but grounded. Think: motivational year-in-review energy — not party music, but the kind of beat that makes you feel proud of what you built. Warm synth, upbeat tempo (around 100 BPM), resolves into something softer at the end. No lyrics — the numbers are the message.
...
- **Duration: 30–35 seconds.** The number reveals need breathing room. Don't rush.
- **Color palette:** Dark background (near-black or deep indigo), bright white numbers, warm accent color (gold or amber) for the final stat reveal. Signals celebration without being garish.
- **Russian subtitle option:** Add a brief Russian caption block for bilingual reach — Russian-speaking teachers will see these numbers too.
