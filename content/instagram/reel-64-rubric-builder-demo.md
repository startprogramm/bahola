# Reel 64 — Rubric Builder: Build Your First Rubric in 90 Seconds

**Campaign:** Week 32 — Feature Deep Dive: Rubric Builder & Assessment Types (Jan 11-15, 2027)
**Duration:** 45-60 seconds
**Theme:** Product demo reel — hands-on screen recording of the rubric builder. Fast, satisfying, shows the product in action. Target: teachers who haven't tried rubrics yet.

---

## Hook Frame (0-3s)
Close-up of teacher's hands at keyboard. Screen shows a blank assessment form.

**Text overlay:** "1:30 da o'z rubrikingizni yarating"
*(Translation: "Build your own rubric in 90 seconds")*
...
| 23-28s | Adds criterion 2: "Grammatika — 3 ball". Adds criterion 3: "Kreativlik — 2 ball" | Criteria 2 and 3 fill in ✅ | Fast-forward energy |
| 29-33s | Total: 10 ball. Green "Tayyor" button appears. Teacher clicks it. | "Jami: 10 ball ✅" | "Siz tayyor — rubrik saqlanib qoldi" |
...
Yaxshi baholash = o'quvchi NIMA uchun shu ball olganini tushunishi.

Rubrik bilan siz belgilaysiz:
📌 Asosiy g'oya — 5 ball
📌 Grammatika — 3 ball
📌 Ijodiylik — 2 ball

AI shu mezonlar asosida baholaydi. Har bir o'quvchi — alohida, batafsil fikr-mulohaza oladi.
...
Хорошая оценка — это когда ученик понимает, ПОЧЕМУ он получил именно этот балл.

С рубрикой вы задаёте критерии:
📌 Основная идея — 5 баллов
📌 Грамматика — 3 балла
📌 Креативность — 2 балла

ИИ оценивает по вашим критериям. Каждый ученик получает развёрнутую, точную обратную связь.
...
- Consider: side-by-side phone and desktop view to show it works on any device
- This reel should be so clear that a teacher could follow along and try it themselves immediately after watching
