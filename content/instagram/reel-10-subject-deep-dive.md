# Reel 10 — Subject Deep Dive: AI Grades a Math Problem

**Filename:** `reel-10-subject-deep-dive.md`
**Campaign:** Week 5 — Back-to-School Post-Eid
**Duration:** 30–45 seconds
**Format:** Screen capture / product demo with text overlays
**Language:** Uzbek (overlays + caption)
...
- Upbeat lo-fi or soft electronic track (no lyrics)
- Optional: satisfying "ding" sound effect when grade appears
...
```
Matematika ishi — AI ko'zi bilan 👁️📐
...
- Use real product screenshots (no mock-ups)
- Student name must be fictional or redacted
- Ensure OCR and feedback screens are legible at mobile size
- Aspect ratio: 9:16 (vertical Reels format)
- Suggested transition: quick cut on each stage, not swipe/dissolve
