...
**[6–16s] — Sinf yaratish / Создание класса**
- Teacher taps "Yangi sinf" — fills in class name ("9-B Fizika"), subject, short description
- Taps "Saqlash" — class appears with a unique join code
- Overlay (UZ): "Sinf tayyor — kodingiz bor!"
- Overlay (RU): "Класс готов — ваш код создан!"
- Timer: 2:10

**[16–28s] — Topshiriq yaratish / Создание задания**
- Teacher taps "Yangi topshiriq" inside the class
- Fills in title: "1-Bob: Mexanika" — types out a short mark scheme
- Taps "Faollashtirish" — assessment goes live
- Overlay (UZ): "Baholash sxemasi qo'shildi. Topshiriq faol."
- Overlay (RU): "Схема оценивания добавлена. Задание активно."
- Timer: 3:45

**[28–36s] — Havolani yuborish / Отправка ссылки**
- Teacher opens "A'zolar" tab → "Taklif havolasini nusxalash" → pastes link into Telegram group
- First student notification pops on screen: "Karimov Jasur sinfga qo'shildi ✅"
- Overlay (UZ): "Havola yuborildi. O'quvchi qo'shildi."
- Overlay (RU): "Ссылка отправлена. Ученик присоединился."
- Timer: 4:52
...
```
⏱ 5 daqiqa. Yangi o'qituvchi. Hamma narsa tayyor.

Ro'yxatdan o'tish → sinf → topshiriq → taklif havola.
...
⏱ 5 минут. Новый учитель. Всё готово.

Регистрация → класс → задание → ссылка-приглашение.
Каждый шаг — 1-2 минуты.
...
- The student join notification at the end is the emotional payoff — make it pop
