# Reel 78 — Class Analytics Dashboard Tour

**Week:** 39 (Mar 1-5, 2027)
**Theme:** Assessment Analytics — Data-Driven Teaching Insights
**Format:** 30s screen-capture with Uzbek voiceover
...
| 21-26s | Teacher taps a weak topic — drill-down shows which questions students missed most | Smart insight callout appears |
| 27-30s | Teacher smiles, closes laptop — ready to plan next lesson | "Darsni rejalashtirish osonlashdi" |
...
- Use screen-capture recording of actual dashboard
- Highlight UI elements with subtle zoom/glow on key data points
- Background music: calm, focused (lofi-style)
