...
# Your First AI-Graded Class in 10 Minutes

This guide takes you from zero to your first AI-graded results. It takes about 10 minutes. Let's go.
...
![Members tab showing enrolled students](/blog/app-members-tab.png)

## Step 4: Create a Test

Inside your class, click **New Assessment**.

![Creating a new test — answer key, marks per question, and feedback language](/blog/app-create-assessment.png)

Fill in:
- **Title** — what are you testing? (e.g., "Chapter 3 Test")
- **Answer key** — paste your answers, or upload a file (PDF, Word, Excel, or image). This is what the AI uses to grade.
- **Marks per question** — how many points each question is worth
- **Feedback language** — Uzbek, Russian, or English

Click **Create Assessment**. The answer key is ready right away.

> **Pro tip:** The more detail in your answer key, the better the feedback. If your key says "any valid example," add a few examples of what counts.

## Step 5: Students Submit Their Work
...
Go to your test and open **Submissions**. You'll see every student's total score, question-by-question marks, and the AI's written feedback.

![Test created — ready for student submissions](/blog/app-assessment-created.png)

If any score looks wrong, click the submission and use **Adjust Score** to fix it. You can change any question's mark and add a note.

## Step 7: Check the Grades Overview

Open the **Grades** tab in your class. You get a full table — every student, every test, every score — sorted any way you like.
...
*Questions? Post in your class stream or visit the [support page](/support).*
